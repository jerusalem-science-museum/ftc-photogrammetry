# Shared model folder on the outside-screen computer.
photogrammetry_data_path = r'/mnt/shared_in/photogrammetry_data'

# Relative paths inside each timestamp-named model folder.
obj_path = r'output/texturedMesh.obj'  # DO NOT CHANGE
texture_path = r'output/texture_1001.png'  # DO NOT CHANGE

# New folders may appear before all files are fully copied.
...
# Gallery starts on the newest model and keeps at most this many loaded/available.
model_number = 0
MAX_MODEL_NUMBER = 15
