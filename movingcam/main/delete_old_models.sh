...
PARENT_FOLDER="/home/mada/photogrammetry_data"
IMAGES_FOLDER="/home/mada/photogrammetry_images"

# Define the cleanup limits
AGE_THRESHOLD=30  # days
MIN_MODELS=30     # highest priority: never delete below this number
MAX_MODELS=10000     # second priority: keep only this many newest models
